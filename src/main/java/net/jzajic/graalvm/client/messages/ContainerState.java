...
public class ContainerState {
  ...
  static ContainerState create(
    ...
    return new ContainerState(status, running, addr, restarting, pid, exitCode,
        startedAt, finishedAt, error, oomKilled, health);
  }
  
  public ContainerState(String status, Boolean running, Boolean paused, Boolean restarting, Integer pid, Long exitCode, Date startedAt, Date finishedAt, String error, Boolean oomKilled, Health health) {
		super();
		this.status = status;
