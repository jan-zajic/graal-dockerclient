...
public class ProgressMessage {
  ...
  public static Builder builder() {
    return new ProgressMessage.Builder();
  }
  ...
  public  static class Builder extends AbstractBuilder {
    ...
    public  Builder status(String status) { build.status = status; return this; };

    public  Builder stream(String stream) { build.stream = stream; return this; };

    public  Builder error(String error) { build.error = error; return this; };

    public  Builder progress(String progress) { build.progress = progress; return this; };

    public  Builder progressDetail(ProgressDetail progressDetail) { build.progressDetail = progressDetail; return this; };

    public ProgressMessage build= new ProgressMessage();
  }
  ...
  public String buildImageId() {
    ...
    final String stream = this.stream;
