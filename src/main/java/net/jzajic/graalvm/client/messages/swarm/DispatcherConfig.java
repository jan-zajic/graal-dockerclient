...
public class DispatcherConfig {
  ...
  public  static class Builder extends SwarmAbstractBuilder {
    ...
    public  Builder heartbeatPeriod(Long heartbeatPeriod) { build.heartbeatPeriod = heartbeatPeriod; return this; };

    public DispatcherConfig build = new DispatcherConfig();
  }

  public static DispatcherConfig.Builder builder() {
    return new DispatcherConfig.Builder();
  }
}
