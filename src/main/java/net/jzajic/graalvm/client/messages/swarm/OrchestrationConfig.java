...
public class OrchestrationConfig {
  ...
  public  static class Builder extends SwarmAbstractBuilder {
    ...
    public  Builder taskHistoryRetentionLimit(Integer taskHistoryRetentionLimit) { build.taskHistoryRetentionLimit = taskHistoryRetentionLimit; return this; };

    public OrchestrationConfig build = new OrchestrationConfig();
  }
