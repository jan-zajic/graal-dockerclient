...
import net.jzajic.graalvm.client.DockerCredentialHelper.CredentialHelperDelegate;
import net.jzajic.graalvm.client.messages.DockerCredentialHelperAuth;
...
public class DockerConfigReaderTest {
  ...
  public void testFromDockerConfig_FullConfig() throws Exception {
    ...
    assertThat(registryAuth, struct(DOCKER_AUTH_CONFIG));
  }
  ...
  public void testFromDockerConfig_IdentityToken() throws Exception {
    ...
    assertThat(authConfig, struct(IDENTITY_TOKEN_AUTH_CONFIG));
  }
  ...
  public void testFromDockerConfig_IncompleteConfig() throws Exception {
    ...
    assertThat(registryAuth, struct(expected));
  }
  ...
  public void testFromDockerConfig_MissingConfigFile() throws Exception {
    final Path randomPath = Paths.get("5140189282398450" + ".json");
  ...
  public void testFromDockerConfig_MultiConfig() throws Exception {
    ...
    assertThat(myDockParsed, struct(MY_AUTH_CONFIG));

    final RegistryAuth dockerIoParsed = reader.authForRegistry(path, "https://index.docker.io/v1/");
    assertThat(dockerIoParsed, struct(DOCKER_AUTH_CONFIG));
  }
  ...
  public void testParseRegistryConfigs() throws Exception {
    ...
    assertThat(configs.configs, allOf(
        hasKey("https://index.docker.io/v1/"),
        hasKey("https://narnia.mydock.io/v1/")
    ));
  }
  ...
  public void testParseNoAuths() throws Exception {
    ...
    final RegistryConfigs configs = reader.authForAllRegistries(path);
    assertThat(configs, struct(RegistryConfigs.empty()));
  }
  ...
  public void testCredHelpers() throws Exception {
    ...
    assertThat(configs, struct(expected));
  }
  ...
  public void testCredsStoreAndCredHelpersAndAuth() throws Exception {
    ...
    assertThat(reader.authForRegistry(path, registry1), struct(DOCKER_AUTH_CONFIG));
    ...
    when(credentialHelperDelegate.get("magic-missile", registry2)).thenReturn(testAuth2);
    assertThat(reader.authForRegistry(path, registry2), struct(testAuth2.toRegistryAuth()));
    ...
    assertThat(reader.authForRegistry(path, registry3), struct(testAuth3.toRegistryAuth()));
    ...
    final RegistryConfigs registryConfigs = RegistryConfigs.builder()
            ...
            .build;
    assertThat(reader.authForAllRegistries(path), struct(registryConfigs));
  }
