...
import static net.jzajic.graalvm.client.SystemCredentialHelperDelegate.readServerAuthDetails;
...
public class SystemCredentialHelperDelegateTest {
  ...
  public void testReadServerAuthDetails() throws Exception {
    ...
    assertThat(auth, is(struct(DockerCredentialHelperAuth.class)
